...
public void OpenMenuSettings(int client)
{
	...
	menu.AddItem("discord", "Discord Webhooks");
	menu.AddItem("updater", "Updater");
...
public int MenuHandlerSettings(Menu menu, MenuAction action, int client, int choice)
{
	if (action == MenuAction_Select)
	{
		...
		else if (StrEqual(menuItem, "discord"))			OpenMenuDiscord(client);
		else if (StrEqual(menuItem, "updater"))			OpenMenuUpdater(client);
